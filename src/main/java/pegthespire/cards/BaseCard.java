...
import pegthespire.util.CardStats;
import pegthespire.util.TriFunction;
...
import static pegthespire.util.GeneralUtils.removePrefix;
import static pegthespire.util.TextureLoader.getCardTextureString;
...
public abstract class BaseCard extends CustomCard {
    ...
    protected static String makeID(String name) { return PegTheSpireMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    PegTheSpireMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
